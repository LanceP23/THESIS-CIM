...
const StudentMobileUserReg = () => {
    ...
    return (
        <div className="registration_form">
            <h2>Student Mobile User Registration</h2>
            <form onSubmit={handleSubmit}>
                ...
                <label>
                    Education Level:
                    <select className="input_field" value={educationLevel} onChange={(e) => setEducationLevel(e.target.value)}>
                ...
                {educationLevel === "Senior High School" && (
                    <div>
                        ...
                        <label>
                            ...
                            <select className="input_field" value={highSchoolYearLevel} onChange={(e) => setHighSchoolYearLevel(e.target.value)}>
                ...
                {educationLevel === "College" && (
                    <div>
                        <label>
                            College Course:
                            <select className="input_field" value={collegeCourse} onChange={(e) => setCollegeCourse(e.target.value)}>
