    ...
    <h2 className='text-4xl text-green-800 border-b-2 border-yellow-500 py-2 my-2'>Build Community</h2>
            ...
            <div className="divider divider-horizontal divider-warning"></div>
             ...
             {/* Selected Members */}
              ...
              <div className="w-full max-w-lg  border-2 border-white shadow-lg my-4 rounded-xl p-3  ">
                  <div className="flex flex-row justify-between">
                  <h2 className="text-lg font-bold mb-4 border-b-2 text-green-500">Selected Members</h2>
                  <button onClick={() => setSelectedMembers([])} className="mt-4 mb-2 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Remove All</button>
                  </div>
